...
<body>
    ...
    <div class="container-fluid fixed-top">
        <div class="card text-white bg-dark">
            <h1 class="card-header" style="text-align: center;">Dodaj Izvođača</h1>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-8">
                <div class="card text-white bg-dark">
                    <div class="card-body">
                        <form action="php/napraviIzvodjaca.php" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="zanr" name="zanr" required class="form-control">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" id="slika" name="slika" required class="form-control">
                            </div>
                            <button type="button" class="btn btn-primary"><a href="izvodjac.php">Nazad</a></button>
                            <button type="submit" class="btn btn-primary">Dodaj Izvođača</button>
                        </form>
                    </div>
